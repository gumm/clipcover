...
var coveragePlugin = require('./coverage').jsCoverageReporter;
...
/**
* A console writer.
* @type {reportPlugin.Dot|
    reportPlugin.Spec|
    reportPlugin.Tap|
    reportPlugin.Html}
*/
var spec = new reportPlugin[config.outputFormat]();

/**
* A output file writer.
* @type {reportPlugin.Tap}
*/
var tap = new reportPlugin.Tap(config.outputFile, fs);
...
* @type {coveragePlugin}
*/
var coverage = new coveragePlugin();
